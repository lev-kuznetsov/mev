...
public class InvalidDatasetNameException extends DatasetException {
   ...
   * @param message
   */
  public InvalidDatasetNameException (String message) {
    super (message);
  }
   ...
   * @param cause
   */
  public InvalidDatasetNameException (Throwable cause) {
    super (cause);
  }
   ...
   * @param cause
   */
  public InvalidDatasetNameException (String message, Throwable cause) {
    super (message, cause);
  }
