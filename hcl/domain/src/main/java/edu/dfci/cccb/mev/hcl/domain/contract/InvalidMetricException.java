 ...
 * 
 */
public class InvalidMetricException extends MevException {
  ...
  public InvalidMetricException name (String name) {
   ...
   */
  public InvalidMetricException (String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
