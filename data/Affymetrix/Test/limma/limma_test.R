...
write.table(gsea_rnk, file="../../../../data/Affymetrix/Test/limma/rnk_out.txt", quote=FALSE, sep="\t", row.names=FALSE, col.names=FALSE)
...
tryCatch ({
  ...
  ## output file
  # "../../../../data/Affymetrix/Test/limma/topgo_out.txt"
  ...
  write.table(file="../../../../data/Affymetrix/Test/limma/topgo_out.txt", topGO.table, sep='\t', quote=FALSE, row.names=FALSE, col.names=FALSE)
...
write.table(result[,-c(4,7)], 
            file="../../../../data/Affymetrix/Test/limma/result_out.txt", quote=FALSE, sep="\t", row.names=FALSE, col.names=FALSE)
