...
package edu.dfci.cccb.mev.googleplus.services.mappers;
...
public class UnauthorizedExceptionMapper extends MevExceptionMapper<UnauthorizedException> {
   ...
   * toResponseBuilder(edu.dfci.cccb.mev.common.domain.support.MevException) */
  @Override
  protected ResponseBuilder toResponseBuilder (UnauthorizedException exception) {
    return super.toResponseBuilder (exception).status (UNAUTHORIZED);
  }
}
