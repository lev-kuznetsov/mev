...
public class PeopleSerializer extends JsonSerializer<People> {
  ...
  @Override
  public Class<People> handledType () {
    return People.class;
  }
  ...
  @Override
  public void serialize (People value, JsonGenerator jgen, SerializerProvider provider) throws IOException,
                                                                                       JsonProcessingException {
    jgen.writeStartObject ();
    jgen.writeNumberField ("count", value.getTotalItems ());
    jgen.writeEndObject ();
  }
}
