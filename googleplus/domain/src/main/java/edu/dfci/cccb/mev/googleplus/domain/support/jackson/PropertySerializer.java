...
public class PropertySerializer extends JsonSerializer<Property> {
  ...
  @Override
  public void serialize (Property value, JsonGenerator jgen, SerializerProvider provider) throws IOException,
                                                                                         JsonProcessingException {
    jgen.writeStartObject ();
    jgen.writeStringField (value.getKey (), value.getValue ());
    jgen.writeStringField ("visibility", value.getVisibility ());
    jgen.writeEndObject ();
  }
}
