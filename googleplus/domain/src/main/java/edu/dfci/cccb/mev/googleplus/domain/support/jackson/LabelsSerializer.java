 ...
 * @since CRYSTAL
 */
public class LabelsSerializer extends JsonSerializer<Labels> {
  ...
  @Override
  public void serialize (Labels value, JsonGenerator jgen, SerializerProvider provider) throws IOException,
