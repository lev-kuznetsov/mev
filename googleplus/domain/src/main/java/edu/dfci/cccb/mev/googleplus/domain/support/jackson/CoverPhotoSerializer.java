 ...
 * @author levk
 */
public class CoverPhotoSerializer extends JsonSerializer<CoverPhoto> {

  /* (non-Javadoc)
   * @see com.fasterxml.jackson.databind.JsonSerializer#handledType() */
  @Override
  public Class<CoverPhoto> handledType () {
    return CoverPhoto.class;
  }
  ...
  @Override
  public void serialize (CoverPhoto value, JsonGenerator jgen, SerializerProvider provider) throws IOException,
