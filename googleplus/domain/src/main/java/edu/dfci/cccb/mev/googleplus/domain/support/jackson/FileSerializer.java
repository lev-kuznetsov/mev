...
public class FileSerializer extends JsonSerializer<File> {
  ...
  public void serialize (File value, JsonGenerator jgen, SerializerProvider provider) throws IOException,
    ...
    jgen.writeNumberField ("size", value.getFileSize ());
    jgen.writeStringField ("id", value.getId ());
    provider.defaultSerializeField ("owners", value.getOwners (), jgen);
    provider.defaultSerializeField ("labels", value.getLabels (), jgen);
    jgen.writeStringField ("mimetype", value.getMimeType ());
    provider.defaultSerializeField ("properties", value.getProperties (), jgen);
    jgen.writeEndObject ();
  }
}
