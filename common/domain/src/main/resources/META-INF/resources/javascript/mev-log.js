...
define ('mev-log', [ 'log4js' ], function (log4js) {
  ...
  AppliedBrowserConsoleAppender.prototype.append = function (event) {
    if (typeof console != "undefined") {
      ...
      if (console.debug && log4js.Level.DEBUG.isGreaterOrEqual (event.level)) console.debug.apply (console, message);
      ...
      else if (console.error && log4js.Level.ERROR.isGreaterOrEqual (event.level)) console.error.apply (console,
                                                                                                        message);
