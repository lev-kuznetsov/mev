package edu.dfci.cccb.mev.configuration.persistense.hsql;
...
public class HyperSqlDbServer implements SmartLifecycle
{
 ...
 public HyperSqlDbServer(String propertiesFileName)
 {
  properties = new HsqlProperties(propertiesFileName);  
 }
