    ...
    define(['d3'], function(d3){
        ...
        h3atmap = function(){
            ...
            function updateScales(data){
                ...
                axis.x.scale.rangeRoundBands(settings.extent.x, settings.cell['padding-percentage'], 0)
                axis.y.scale.rangeRoundBands(settings.extent.y, settings.cell['padding-percentage'], 0)
