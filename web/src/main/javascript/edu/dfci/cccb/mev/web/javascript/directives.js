define(['angular'], function(angular){
  ...
  .directive('visRadialTree', function() {
    ...
    return {
      ...
      template: '<link rel="stylesheet" href=""><div></div>', //requires css location
      link: function(scope, elems, attr){
                ...
                scope.$watch('data', function(data){
                        ...
                        var wrap = d3.select(elems[0].childNodes[1]).append("svg")
                                .attr("width", r * 2)
                                .attr("height", r * 2)
  ...
  .directive('bsImgbutton', function(){
  ...
  .directive('modalHeirarchical', function(){

    return {
      restrict: 'C',
      templateUrl: "/container/view/elements/heirarchicalbody"
