...
(function() {
    ...
    module.provider("uiBreadcrumbsTemplate", function(){    	
    	this.$get=function(){
			return templateUrl;
		};
		this.setPath=function(url){			
			templateUrl = url;
			console.debug("uiBreadcrumbsTemplate", templateUrl);
		};
    ...
    module.directive('uiBreadcrumbs', ['$interpolate', '$state', function($interpolate, $state) {
            return {
                ...
                templateUrl: function(elem, attrs) {
                	console.debug("uiBreadcrumbsTemplate templateUrl", attrs.templateUrl || templateUrl);
                ...
                link: function(scope) {
                    ...
                    function getDisplayName(currentState) {
                        ...
                        if (propertyReference === false) {
                            ...
                            interpolationContext =  (typeof currentState.locals !== 'undefined') ? currentState.locals.globals : $state.$current.locals.globals;
