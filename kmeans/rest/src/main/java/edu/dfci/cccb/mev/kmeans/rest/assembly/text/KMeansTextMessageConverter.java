 ...
 */
package edu.dfci.cccb.mev.kmeans.rest.assembly.text;
 ...
 * 
 */
public class KMeansTextMessageConverter extends AbstractHttpMessageConverter<KMeans> {

  /**
   * 
   */
  public KMeansTextMessageConverter () {
    super (TEXT_PLAIN);
  }
