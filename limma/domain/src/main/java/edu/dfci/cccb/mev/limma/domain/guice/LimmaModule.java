...
package edu.dfci.cccb.mev.limma.domain.guice;
...
import edu.dfci.cccb.mev.limma.domain.Limma;
import edu.dfci.cccb.mev.limma.domain.TopGo;

/**
 * @author levk
 * @since CRYSTAL
 */
public class LimmaModule extends DatasetModule {
  ...
  public void configure (AnalysisTypeRegistrar registrar) {
    registrar.register (Limma.class);
    registrar.register (TopGo.class);
  }
}
