...
import edu.dfci.cccb.mev.cluster.domain.HierarchicalClusteringAnalysis;
import edu.dfci.cccb.mev.cluster.domain.KMeansClusteringAnalysis;
...
public class ClusteringModule extends DatasetModule {
  ...
  public void configure (AnalysisTypeRegistrar registrar) {
    registrar.register (HierarchicalClusteringAnalysis.class);
    registrar.register (KMeansClusteringAnalysis.class);
  }
}
