...
public class Views {
  ...
  /* @Bean public FreeMarkerView annotations () { return freemarker ().url
   * ("/edu/dfci/cccb/mev/annotation/client/views/annotations.ftl").build (); } */
  @Bean
  public FreeMarkerView annotations () throws TemplateModelException {
    ...
    TemplateHashModel dimensionTypeEnums = (TemplateHashModel) enumModels.get ("edu.dfci.cccb.mev.dataset" +
                                                                               ".domain.contract.Dimension$Type");
